/*
  ...
  gengetopt -i /home/jed/proj/libwebcam/Apps/uvcdynctrl/uvcdynctrl.ggo --output-dir /home/jed/proj/libwebcam/Apps/uvcdynctrl --unamed-opts=VALUES 
...
const char *gengetopt_args_info_purpose = "Manage dynamic controls in uvcvideo";

const char *gengetopt_args_info_usage = "Usage: uvcdynctrl [OPTIONS]... [VALUES]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'l':	/* List available cameras.  */
          ...
          break;
        case 'i':	/* Import dynamic controls from an XML file.  */
        
        
          if (update_arg( (void *)&(args_info->import_arg), 
               &(args_info->import_orig), &(args_info->import_given),
              &(local_args_info.import_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "import", 'i',
              additional_error))
            goto failure;
        ...
        case 'd':	/* Specify the device to use.  */
          ...
          if (update_arg( (void *)&(args_info->device_arg), 
              ...
              &(local_args_info.device_given), optarg, 0, "video0", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "device", 'd',
              additional_error))
            goto failure;
          ...
          break;
        case 'c':	/* List available controls.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->clist_given),
              &(local_args_info.clist_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "clist", 'c',
              additional_error))
            goto failure;
          ...
          break;
        case 'g':	/* Retrieve the current control value.  */
          ...
          break;
        case 's':	/* Set a new control value\n(For negative values: -s 'My Control' -- -42).  */
        
        
          if (update_arg( (void *)&(args_info->set_arg), 
               &(args_info->set_orig), &(args_info->set_given),
              &(local_args_info.set_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "set", 's',
              additional_error))
            goto failure;
        ...
        case 'f':	/* List available frame formats.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->formats_given),
              &(local_args_info.formats_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "formats", 'f',
              additional_error))
            goto failure;
